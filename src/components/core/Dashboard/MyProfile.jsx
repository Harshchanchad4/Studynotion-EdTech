...
export default function MyProfile() {
  ...
  return (
    ...
    <>
      ...
      <div className="flex relative items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-3 sm:px-12">
        ...
        <button className="absolute top-3 md:hidden right-4 " onClick={() => { navigate("/dashboard/settings") }}>
      ...
      <div className="relative my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-3 sm:px-12">
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <button className="absolute top-3 md:hidden right-4 bg" onClick={() => { navigate("/dashboard/settings") }}>
      ...
      <div className="my-10 relative flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-3 sm:px-12">
        ...
        <div className="flex  max-w-[500px] justify-around">
