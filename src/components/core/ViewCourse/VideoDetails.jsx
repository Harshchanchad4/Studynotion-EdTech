    ...
    <div className="flex flex-col justify-center items-center gap-5 text-white ">
      {!videoData ? (
        ...
        <div className="w-[80%] mt-10">
          ...
          <Player ref={playerRef} className="flex justify-center items-center" aspectRatio="16:9" playsInline onEnded={() => setVideoEnded(true)} src={videoData?.videoUrl} >
      ...
      <h1 className="mt-4 ml-10 w-[80%]  text-3xl font-semibold text-left">{videoData?.title}</h1>
      <p className="pt-2 ml-10 w-[80%]  pb-6">{videoData?.description}</p>
